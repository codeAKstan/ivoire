                ...
                <nav class="px-4 py-4 space-y-8">
                    ...
                    <div>
                        ...
                        <div class="space-y-1">
                            ...
                            <a href="{{ route('admin.testimonials') }}" class="flex items-center gap-4 px-4 py-3 rounded-xl {{ request()->routeIs('admin.testimonials') ? 'bg-[#cda151] text-white' : 'text-white/60 hover:text-white hover:bg-white/5' }} transition-all">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"></path></svg>
                                <span class="text-sm font-medium" :class="!sidebarOpen && 'md:hidden'">Client Stories</span>
                            </a>
                        </div>
                    </div>
