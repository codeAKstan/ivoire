            ...
            <section class="relative min-h-[60vh] flex flex-col items-center justify-center text-center px-6 overflow-hidden">
                ...
                <div class="relative z-10 max-w-5xl mx-auto pt-20">
                    <div class="flex items-center justify-center gap-4 mb-8 opacity-0 animate-[fadeIn_1s_ease-out_forwards]">
                        <div class="h-[0.5px] w-12 md:w-20 bg-[#18c596]/50"></div>
                        <span class="text-[10px] md:text-xs font-bold tracking-[0.4em] uppercase text-[#18c596]">Connect</span>
                        <div class="h-[0.5px] w-12 md:w-20 bg-[#18c596]/50"></div>
                    </div>
                    ...
                    <h1 class="text-4xl md:text-6xl lg:text-7xl font-light leading-tight mb-8 tracking-tight opacity-0 animate-[fadeInUp_1s_ease-out_0.3s_forwards]" style="font-family: 'Playfair Display', serif;">
                        Let's build your <span class="italic text-[#18c596]">legal infrastructure.</span>
                    </h1>
                ...
                <div class="max-w-7xl mx-auto">
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-20">
                        ...
                        <div class="space-y-12">
                            <div>
                                <h2 class="text-3xl md:text-4xl font-light text-white mb-8" style="font-family: 'Playfair Display', serif;">Direct <span class="italic text-[#18c596]">Channels</span></h2>
                            ...
                            <div class="space-y-8">
                                <div class="flex items-start gap-6 group">
                                    <div class="w-12 h-12 bg-[#111111] border border-white/5 flex items-center justify-center rounded-xl group-hover:border-[#18c596]/50 transition-all duration-500">
                                        <svg class="w-5 h-5 text-[#18c596]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                                    </div>
                                    <div>
                                        <p class="text-white/40 text-[10px] font-bold uppercase tracking-widest mb-1">Email Us</p>
                                        <a href="mailto:info@ivoirelegal.com" class="text-white text-lg hover:text-[#18c596] transition-colors">info@ivoirelegal.com</a>
                                    </div>
                                </div>

                                <div class="flex items-start gap-6 group">
                                    <div class="w-12 h-12 bg-[#111111] border border-white/5 flex items-center justify-center rounded-xl group-hover:border-[#18c596]/50 transition-all duration-500">
                                        <svg class="w-5 h-5 text-[#18c596]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                                    </div>
                                    <div>
                                        <p class="text-white/40 text-[10px] font-bold uppercase tracking-widest mb-1">Call Us</p>
                                        <a href="tel:+2348060663685" class="text-white text-lg hover:text-[#18c596] transition-colors">+234 806 066 3685</a>
                                    </div>
                                </div>
                        ...
                        <div class="flex flex-col justify-center items-center lg:items-start space-y-10">
                            <div class="bg-[#111111] p-12 md:p-16 rounded-[40px] border border-white/5 shadow-2xl w-full text-center lg:text-left">
                                <h3 class="text-2xl md:text-3xl font-light text-white mb-6" style="font-family: 'Playfair Display', serif;">Ready to <span class="italic text-[#18c596]">Start?</span></h3>
                                ...
                                <a href="https://calendly.com/ivoirelegal" target="_blank" class="inline-flex items-center justify-center gap-3 bg-[#18c596] hover:bg-[#15b085] text-black font-bold px-10 py-5 rounded-xl uppercase tracking-[0.2em] text-xs transition-all duration-500 shadow-lg shadow-[#18c596]/20 group">
                                    Book a Consultation
