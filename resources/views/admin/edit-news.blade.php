    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-2xl p-10 shadow-sm border border-gray-50">
            <div class="flex items-center justify-between mb-10">
                <div>
                    <h3 class="text-2xl font-bold text-[#151515]" style="font-family: 'Playfair Display', serif;">Edit Publication</h3>
            ...
            <form action="{{ route('admin.news.update', $post) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="title" value="{{ old('title', $post->title) }}" class="w-full bg-[#FAF8F5] border-none text-[#151515] px-6 py-4 rounded-2xl focus:ring-1 focus:ring-[#cda151] transition-all text-sm font-medium">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            @endif
                            <label class="flex flex-col items-center justify-center w-full h-[100px] bg-[#FAF8F5] border-2 border-dashed border-gray-200 rounded-3xl cursor-pointer hover:bg-gray-100 transition-all group">
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="content" rows="15" class="w-full bg-[#FAF8F5] border-none text-[#151515] px-8 py-6 rounded-[30px] focus:ring-1 focus:ring-[#cda151] transition-all text-sm font-medium leading-relaxed">{{ old('content', $post->content) }}</textarea>
