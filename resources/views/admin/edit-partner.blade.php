    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-2xl p-10 shadow-sm border border-gray-50">
            <div class="flex items-center justify-between mb-10">
                <div>
                    <h3 class="text-2xl font-bold text-[#151515]" style="font-family: 'Playfair Display', serif;">Edit Partner</h3>
                    <p class="text-gray-400 text-sm font-light mt-1">Update information for {{ $partner->name }}.</p>
                </div>
                <a href="{{ route('admin.partners') }}" class="text-[#cda151] text-xs font-bold uppercase tracking-widest hover:underline flex items-center gap-2">
            ...
            <form action="{{ route('admin.partners.update', $partner) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="name" value="{{ old('name', $partner->name) }}" class="w-full bg-[#FAF8F5] border-none text-[#151515] px-6 py-4 rounded-2xl focus:ring-1 focus:ring-[#cda151] transition-all text-sm font-medium">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center gap-6 p-6 bg-gray-50 rounded-3xl border border-gray-100">
                            ...
                            <div class="flex-1">
                                <p class="text-xs font-semibold text-[#151515] mb-1">Current Logo</p>
                                <p class="text-[10px] text-gray-400 uppercase tracking-widest">Upload a new one to replace it</p>
                            </div>
                        </div>
                        <label class="flex items-center justify-center gap-2 bg-white border-2 border-dashed border-gray-200 hover:border-[#cda151] text-gray-400 hover:text-[#cda151] px-6 py-6 rounded-2xl cursor-pointer transition-all group">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="url" name="website" value="{{ old('website', $partner->website) }}" placeholder="https://..." class="w-full bg-[#FAF8F5] border-none text-[#151515] px-6 py-4 rounded-2xl focus:ring-1 focus:ring-[#cda151] transition-all text-sm font-medium">
