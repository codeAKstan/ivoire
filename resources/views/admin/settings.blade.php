<x-app-layout>
    ...
    <div class="max-w-4xl" x-data="{ tab: 'profile', showAddForm: false }">
        ...
        <div class="flex items-center gap-8 mb-8 border-b border-gray-100 px-2">
            <button 
                @click="tab = 'profile'" 
                :class="tab === 'profile' ? 'border-[#cda151] text-[#151515]' : 'border-transparent text-gray-400 hover:text-gray-600'"
            ...
            <button 
                @click="tab = 'social'" 
                :class="tab === 'social' ? 'border-[#cda151] text-[#151515]' : 'border-transparent text-gray-400 hover:text-gray-600'"
                class="pb-4 px-2 border-b-2 font-bold text-xs uppercase tracking-widest transition-all"
            >
                Social Accounts
            </button>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-50 overflow-hidden">
            @if (session('status') == 'password-updated')
                <div class="bg-[#cda151]/10 border-l-4 border-[#cda151] p-6 m-10 mb-0 rounded-xl flex items-center gap-4 animate-fadeIn">
                    ...
                    <div>
                        <p class="text-[#151515] font-bold text-sm">Password Updated!</p>
            ...
            @if (session('status') == 'social-updated')
                <div class="bg-[#cda151]/10 border-l-4 border-[#cda151] p-6 m-10 mb-0 rounded-xl flex items-center gap-4 animate-fadeIn">
                    ...
                    <div>
                        <p class="text-[#151515] font-bold text-sm">Socials Updated!</p>
            ...
            <div x-show="tab === 'profile'" x-cloak class="animate-fadeIn">
                <div class="p-10 border-b border-gray-50">
                    <h3 class="text-xl font-bold text-[#151515]" style="font-family: 'Playfair Display', serif;">Account Settings</h3>
                ...
                <div class="p-10 space-y-10">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div>
                            <h4 class="text-sm font-bold text-[#151515] uppercase tracking-widest">Admin Profile</h4>
                            <p class="text-xs text-gray-400 mt-2 font-light">Public information about your account.</p>
                        </div>
                        <div class="md:col-span-2 space-y-6">
                            <div class="flex items-center gap-6 mb-8">
                                <div class="w-20 h-20 bg-gradient-to-tr from-[#cda151] to-[#151515] rounded-3xl flex items-center justify-center text-white font-bold text-2xl shadow-xl shadow-[#cda151]/20">
                                    {{ substr(Auth::user()->name, 0, 1) }}
                                </div>
                                <button class="bg-[#FAF8F5] hover:bg-gray-100 text-[#151515] px-6 py-3 rounded-xl text-xs font-bold uppercase tracking-widest transition-all">
                                    Change Photo
                                </button>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="space-y-2">
                                    ...
                                    <input type="text" value="{{ Auth::user()->name }}" class="w-full bg-[#FAF8F5] border-none text-[#151515] px-6 py-4 rounded-2xl focus:ring-1 focus:ring-[#cda151] transition-all text-sm font-medium">
                                </div>
                                <div class="space-y-2">
                                    <label class="text-[10px] font-bold uppercase tracking-widest text-gray-400">Email Address</label>
                                    <input type="email" value="{{ Auth::user()->email }}" class="w-full bg-[#FAF8F5] border-none text-[#151515] px-6 py-4 rounded-2xl focus:ring-1 focus:ring-[#cda151] transition-all text-sm font-medium">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <form method="POST" action="{{ route('user-password.update') }}" class="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        @method('PUT')
                        <div>
                            <h4 class="text-sm font-bold text-[#151515] uppercase tracking-widest">Security</h4>
                        ...
                        <div class="md:col-span-2 space-y-6">
                            <div class="space-y-2">
                                ...
                                <input type="password" name="current_password" placeholder="••••••••" class="w-full bg-[#FAF8F5] border-none text-[#151515] px-6 py-4 rounded-2xl focus:ring-1 focus:ring-[#cda151] transition-all text-sm font-medium @error('current_password', 'updatePassword') ring-1 ring-red-500 @enderror">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="space-y-2">
                                    ...
                                    <input type="password" name="password" placeholder="••••••••" class="w-full bg-[#FAF8F5] border-none text-[#151515] px-6 py-4 rounded-2xl focus:ring-1 focus:ring-[#cda151] transition-all text-sm font-medium @error('password', 'updatePassword') ring-1 ring-red-500 @enderror">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="password" name="password_confirmation" placeholder="••••••••" class="w-full bg-[#FAF8F5] border-none text-[#151515] px-6 py-4 rounded-2xl focus:ring-1 focus:ring-[#cda151] transition-all text-sm font-medium">
                                </div>
                            </div>

                            <div class="flex justify-end pt-4">
                                <button type="submit" class="bg-[#cda151] hover:bg-[#b88f40] text-white px-10 py-5 rounded-2xl text-xs font-bold uppercase tracking-widest transition-all shadow-xl shadow-[#cda151]/20">
                                    Update Password
                                </button>
                            </div>
                        </div>
            ...
            <div x-show="tab === 'social'" x-cloak class="animate-fadeIn">
                <div class="p-10 border-b border-gray-50 flex items-center justify-between">
                    <div>
                        <h3 class="text-xl font-bold text-[#151515]" style="font-family: 'Playfair Display', serif;">Social Accounts</h3>
                ...
                <div class="p-10 space-y-12">
                    <!-- Add New Form -->
                    <div x-show="showAddForm" x-collapse class="bg-[#FAF8F5] p-8 rounded-[30px] border border-gray-100 mb-12" x-data="{ selectedPlatform: '' }">
                        <h4 class="text-sm font-bold text-[#151515] mb-6 uppercase tracking-widest">New Social Account</h4>
                        <form action="{{ route('admin.settings.social.store') }}" method="POST" class="space-y-8">
                                ...
                                <div class="grid grid-cols-3 gap-4">
                                    <template x-for="p in ['instagram', 'facebook', 'linkedin']">
                                        <div 
                                            ...
                                            :class="selectedPlatform === p ? 'border-[#cda151] bg-white' : 'border-transparent bg-white/50 hover:bg-white'"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="space-y-2">
                                    ...
                                    <input type="text" name="name" placeholder="e.g. Ivoire Legal" class="w-full bg-white border-none text-[#151515] px-6 py-4 rounded-2xl focus:ring-1 focus:ring-[#cda151] transition-all text-sm font-medium">
                                </div>
                                <div class="space-y-2">
                                    <label class="text-[10px] font-bold uppercase tracking-widest text-gray-400">Profile Link</label>
                                    <input type="url" name="link" placeholder="https://..." class="w-full bg-white border-none text-[#151515] px-6 py-4 rounded-2xl focus:ring-1 focus:ring-[#cda151] transition-all text-sm font-medium">
                                </div>
                            </div>
                            <div class="flex justify-end">
                                <button type="submit" class="bg-[#cda151] text-white px-8 py-3 rounded-xl text-xs font-bold uppercase tracking-widest hover:bg-[#b88f40] transition-all shadow-lg shadow-[#cda151]/20">Save Platform</button>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="space-y-6" x-data="{ selectedPlatform: '{{ $social->platform }}' }">
                        ...
                        <form action="{{ route('admin.settings.social.update', $social) }}" method="POST" class="space-y-8">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="grid grid-cols-3 gap-4">
                                    <template x-for="p in ['instagram', 'facebook', 'linkedin']">
                                        <div 
                                            @click="selectedPlatform = p"
                                            :class="selectedPlatform === p ? 'border-[#cda151] bg-[#FAF8F5]' : 'border-transparent bg-gray-50 hover:bg-gray-100'"
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                <div class="space-y-2">
                                    <label class="text-[10px] font-bold uppercase tracking-widest text-gray-400">Display Name</label>
                                    <input type="text" name="name" value="{{ $social->name }}" class="w-full bg-[#FAF8F5] border-none text-[#151515] px-6 py-4 rounded-2xl focus:ring-1 focus:ring-[#cda151] transition-all text-sm font-medium">
                                </div>
                                <div class="space-y-2">
                                    <label class="text-[10px] font-bold uppercase tracking-widest text-gray-400">Link</label>
                                    <input type="url" name="link" value="{{ $social->link }}" class="w-full bg-[#FAF8F5] border-none text-[#151515] px-6 py-4 rounded-2xl focus:ring-1 focus:ring-[#cda151] transition-all text-sm font-medium">
                                </div>
                                <div class="space-y-2">
                                    <label class="text-[10px] font-bold uppercase tracking-widest text-gray-400">Status</label>
                                    <select name="status" class="w-full bg-[#FAF8F5] border-none text-[#151515] px-6 py-4 rounded-2xl focus:ring-1 focus:ring-[#cda151] transition-all text-sm font-medium">
